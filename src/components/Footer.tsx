...
//             {/* LARGE LOGO - Forced height for maximum visibility */}
//             <div className="mb-6">
//               <img 
//                 src={logo} 
//                 alt="Yaha Properties" 
//                 style={{ height: '180px', width: 'auto', minHeight: '180px' }} 
//                 className="drop-shadow-2xl transition-transform duration-300 hover:scale-105 block" 
//               />
//             </div>
            
//             <span className="font-heading font-bold text-4xl tracking-tighter mb-4 block">
//               Yaha Properties
//             </span>
            
//             <p className="text-primary-foreground/80 text-base leading-relaxed mb-8 max-w-xs">
...
//                 className="w-11 h-11 rounded-full bg-primary-foreground/10 flex items-center justify-center hover:bg-accent transition-all"
//               >
//                 <Facebook size={20} />
//               </a>
...
//             <h3 className="font-heading font-bold text-xl mb-8 border-l-4 border-accent pl-4">Quick Links</h3>
...
//           {/* Services */}
//           <div className="pt-4 lg:pt-0">
//             <h3 className="font-heading font-bold text-xl mb-8 border-l-4 border-accent pl-4">Services</h3>
//             <ul className="space-y-4">
...
//           {/* Contact Info */}
//           <div className="pt-4 lg:pt-0">
//             <h3 className="font-heading font-bold text-xl mb-8 border-l-4 border-accent pl-4">Contact Info</h3>
...
//           <p className="text-primary-foreground/50 text-xs tracking-widest uppercase font-semibold">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="pt-4 lg:pt-0 text-left">
            ...
            <div className="space-y-5">
              <a href="tel:+918309458058" className="flex items-start gap-4 group">
