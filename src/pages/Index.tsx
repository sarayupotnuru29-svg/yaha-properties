...
//         {/* Hero Content */}
//         <div className="relative z-20 flex-grow flex items-center container mx-auto px-4 md:px-8 pt-32 md:pt-40 pb-20">
//           <div className="max-w-3xl">
//             {/* Primary Action Buttons & Nested Socials */}
//             <div className="flex flex-wrap items-start gap-4 mb-10">
//               <Link to="/properties" className="btn-accent flex items-center gap-2 mt-1">
//                 Explore Properties <ArrowRight size={18} />
//               </Link>

//               {/* WhatsApp + Socials Column */}
...
//                 {/* Social Links Positioned Directly Under WhatsApp */}
//                 <div className="flex flex-col gap-3 px-1">
//                   <a 
//                     href="https://www.facebook.com/share/1E9URqKEay/?mibextid=wwXIfr" 
//                     target="_blank" 
//                     rel="noopener noreferrer" 
//                     className="flex items-center gap-2 text-white hover:text-accent transition-all text-sm font-bold drop-shadow-md group"
//                   >
//                     <Facebook size={18} className="text-accent group-hover:scale-110 transition-transform" />
//                     <span>Yaha Properties</span>
//                   </a>
          ...
          <div className="max-w-3xl">
            ...
            <div className="flex flex-wrap items-start gap-4 mb-10">
              ...
              <div className="flex flex-col gap-4">
                ...
                {/* Social Links Positioned Directly Under WhatsApp - Updated to Blue */}
                <div className="flex flex-col gap-3 px-1">
                  <a 
                    href="https://www.facebook.com/share/1E9URqKEay/?mibextid=wwXIfr" 
                    target="_blank" 
                    rel="noopener noreferrer" 
                    className="flex items-center gap-2 text-blue-500 hover:text-blue-400 transition-all text-sm font-bold drop-shadow-md group"
                  >
