...
// import { ArrowRight, CheckCircle, MapPin, Building2, TrendingUp, Shield } from "lucide-react";
...
//               </Link>
//               <Link to="/contact" className="btn-outline-primary border-primary-foreground text-primary-foreground hover:bg-primary-foreground hover:text-foreground">
//                 Contact Us
//               </Link>
//             </div>
//           </div>
    ...
    <div>
        ...
        <div className="relative z-10 w-full bg-black/30 backdrop-blur-sm border-b border-white/10">
          <div className="container mx-auto px-4 md:px-8 py-3 flex justify-between items-center">
            ...
            >
              ...
              <span>WhatsApp: +91 83094 58058</span>
            </a>
          </div>
        </div>
      ...
      <section className="section-padding gradient-blue text-center">
        <div className="container mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a href="https://wa.me/918309458058" target="_blank" rel="noopener noreferrer" className="btn-accent">
              Talk To Our Experts
            </a>
            <Link to="/services" className="btn-outline-primary border-primary-foreground text-primary-foreground hover:bg-primary-foreground hover:text-foreground">
              View Services
