...
//       {/* Investment Corridor - Connected & Full Cover */}
//       <section 
//         className="relative py-24 md:py-32 flex items-center bg-center bg-no-repeat bg-cover"
//         style={{ backgroundImage: `url(${investmentCorridor})` }}
//       >
//         <div className="container mx-auto px-4 md:px-8">
//           <div className="max-w-lg bg-black/60 backdrop-blur-md p-8 md:p-12 rounded-3xl border border-white/10 shadow-2xl">
