...
//             {/* Mobile View: Icon-Only Links with brand colors centered at bottom */}
//             <div className="flex md:hidden justify-center items-center gap-8 mt-[60vh]">
//                <a 
//                 href="https://www.facebook.com/share/1E9URqKEay/?mibextid=wwXIfr" 
//                 target="_blank" rel="noopener noreferrer"
//                 className="bg-[#1877F2] p-3 rounded-full border border-white/30 text-white shadow-lg transform hover:scale-110 transition-transform"
//               >
//                 <Facebook size={24} />
//               </a>
//               <a 
...
//                 className="bg-gradient-to-br from-[#833AB4] via-[#FD1D1D] to-[#FC913A] p-3 rounded-full border border-white/30 text-white shadow-lg transform hover:scale-110 transition-transform"
//               >
//                 <Instagram size={24} />
//               </a>
//               <a 
//                 href="https://wa.me/918106396021" 
//                 target="_blank" rel="noopener noreferrer"
//                 className="bg-green-500 p-3 rounded-full border border-white/30 text-white shadow-lg transform hover:scale-110 transition-transform"
//               >
//                 <MessageCircle size={24} />
//               </a>
//             </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex md:hidden justify-center items-center gap-6 mb-8 mt-4">
               <a 
                href="https://www.facebook.com/share/1E9URqKEay/?mibextid=wwXIfr" 
                target="_blank" rel="noopener noreferrer"
                className="bg-[#1877F2] p-3 rounded-full text-white shadow-md transform active:scale-95 transition-transform"
              >
                <Facebook size={20} />
              </a>
              <a 
                href="https://instagram.com/yahaproperties" 
                target="_blank" rel="noopener noreferrer"
                className="bg-gradient-to-br from-[#833AB4] via-[#FD1D1D] to-[#FC913A] p-3 rounded-full text-white shadow-md transform active:scale-95 transition-transform"
              >
                <Instagram size={20} />
              </a>
              <a 
                href="https://wa.me/918106396021" 
                target="_blank" rel="noopener noreferrer"
                className="bg-green-500 p-3 rounded-full text-white shadow-md transform active:scale-95 transition-transform"
              >
                <MessageCircle size={20} />
              </a>
            </div>
